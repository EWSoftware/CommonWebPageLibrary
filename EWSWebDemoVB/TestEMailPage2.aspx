<%@ Page MasterPageFile="~/EMailLayout.master" Language="vb" AutoEventWireup="false" Inherits="EWSWebDemoVB.TestEMailPage2" CodeFile="TestEMailPage2.aspx.vb" %>
...
<asp:Button id="btnError" runat="Server" class="FormBtn" Text="Throw"
    Tooltip="Throw an exception" CausesValidation="False" />
<br><br>
