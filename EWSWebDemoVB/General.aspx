<%@ Page MasterPageFile="~/MenuLayout.master" Language="vb" AutoEventWireup="false" Inherits="EWSWebDemoVB.General" CodeFile="General.aspx.vb" %>
  ...
  <tr>
	...
	<td align="right">
		<asp:Button id="btnExit" runat="server" CssClass="FormBtn"
			ToolTip="Exit without saving" Text="Exit" CausesValidation="false" />
	</td>
  </tr>
</table>
