<%@ Page MasterPageFile="~/EMailLayout.master" Language="c#" Inherits="EWSWebDemoCS.ErrorPageInternal" CodeFile="ErrorPageInternal.aspx.cs" %>
...
<br>
<asp:Button id="btnEMail" runat="Server" class="FormBtn" Text="E-Mail" Tooltip="E-Mail the info" onclick="btnEMail_Click" />
<hr>
<!-- NOEMAIL -->
<!-- EMAILCOMMENTS -->
